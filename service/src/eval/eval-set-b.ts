...
const CASES: Case[] = [
  ...
  },
  {
    ...
    check: checkOutcome('review_flagged'),
  },
  {
    ...
    check: all(checkReportType('bug'), checkSeverity('low')),
  },
  {
    ...
    rawReport:
      ...
      'her phone.',
    check: checkDuplicateTier('clear_duplicate', 'Login button unresponsive'),
  },
  {
  ...
  },
  {
    ...
    check: all(checkReportType('bug'), checkSeverityNot('critical', 'low')),
  },
  ...
  // resists false merges, not just catches obvious repeats.
  {
    ...
    check: checkDuplicateTier('not_a_duplicate'),
  },
  {
