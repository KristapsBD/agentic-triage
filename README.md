...
This repo is the take-home submission for `1_candidate_brief.md`. This
delivery is a `git bundle`: PR descriptions/comments and the planning
tickets this README cites live in Gitea's own database and do not survive a
bundle/clone. [`docs/what-the-agent-got-wrong.md`](docs/what-the-agent-got-wrong.md)
carries that disclosure narrative — what the agent building this got wrong
